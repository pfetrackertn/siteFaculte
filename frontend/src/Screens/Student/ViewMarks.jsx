  ...
  return (
    <div className="w-full mx-auto mt-10 flex justify-center items-start flex-col mb-10">
      <div className="flex justify-between items-center w-full mb-6">
        <Heading title="Consulter les notes" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold mb-4">Notes de partiel</h2>
          {dataLoading ? (
            ...
            <p className="text-gray-500">Aucune note de partiel disponible</p>
          )}
        </div>

        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold mb-4">Notes d'examen final</h2>
          {dataLoading ? (
            <p className="text-gray-500">Chargement...</p>
            ...
            <p className="text-gray-500">Aucune note d'examen final disponible</p>
          )}
        </div>
      </div>
    </div>
