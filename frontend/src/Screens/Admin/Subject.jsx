...
const Subject = () => {
  ...
  const addSubjectHandler = async () => {
    ...
    try {
      setDataLoading(true);
      toast.loading(isEditing ? "Mise a jour de la matiere" : "Ajout de la matiere");
      const headers = {
  ...
  const confirmDelete = async () => {
    try {
      setDataLoading(true);
      toast.loading("Suppression de la matiere");
      const headers = {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("userToken")}`,
      };
      ...
      toast.dismiss();
      if (response.data.success) {
        toast.success("La matiere a ete supprimee avec succes");
  ...
  return (
    <div className="w-full mx-auto mt-10 flex justify-center items-start flex-col mb-10">
      <div className="flex justify-between items-center w-full">
        <Heading title="Gestion des matieres" />
        {branch.length > 0 && (
      ...
      {!dataLoading && branch.length === 0 && (
        <div className="flex justify-center items-center flex-col w-full mt-24">
          ...
          <p className="text-center text-lg">
            Veuillez ajouter des filieres avant d'ajouter une matiere.
          </p>
        </div>
      )}
          ...
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end space-x-4 mt-6">
                ...
                >
                  {isEditing ? "Modifier la matiere" : "Ajouter la matiere"}
                </CustomButton>
              </div>
            </div>
          </div>
      ...
      <DeleteConfirm
        ...
        message="Voulez-vous vraiment supprimer cette matiere ?"
      />
    </div>
  );
};
