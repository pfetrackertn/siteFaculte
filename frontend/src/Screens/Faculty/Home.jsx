...
const MENU_ITEMS = [
  { id: "home", label: "Accueil", component: null },
  { id: "timetable", label: "Emploi du temps", component: Timetable },
  { id: "material", label: "Ressources", component: Material },
  { id: "notice", label: "Annonces", component: Notice },
  { id: "student info", label: "Etudiants", component: StudentFinder },
  { id: "marks", label: "Notes", component: Marks },
  { id: "exam", label: "Examens", component: Exam },
];
...
const Home = () => {
  ...
  const renderContent = () => {
    if (selectedMenu === "Accueil" && profileData) {
